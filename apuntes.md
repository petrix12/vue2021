...
1. Modificar vista **07journal\src\modules\daybook\views\EntryView.vue**:
    ...
    ```
2. Modificar el componente **07journal\src\modules\daybook\components\Fab.vue**:
    ```vue
    <template>
        <button class="btn btn-primary">
            <!-- <i class="fa fa-2x fa-plus"></i> -->
...
3. Commit Video 162:
    + $ git add .
    + $ git commit -m "Commit 162: Mini tarea - Fab Icon"
    + $ git push -u origin main
...
1. Modificar vista **07journal\src\modules\daybook\views\EntryView.vue**:
    ...
    ```
2. Crear heper **07journal\src\modules\daybook\helpers\getDayMonthYear.js**:
    ```js
    const months = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio','Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre']
    const days   = ['Domingo','Lunes','Martes','Miércoles','Jueves','Viernes','Sábado']
...
3. Commit Video 169:
    + $ git add .
    + $ git commit -m "Commit 169: Mostrar entrada en pantalla o redireccionar al usuario"
    + $ git push -u origin main
...
2. Commit Video 170:
    + $ git add .
    + $ git commit -m "Commit 170: Cargar entrada cuando cambia el url"
    + $ git push -u origin main
